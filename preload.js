...
contextBridge.exposeInMainWorld("videoAPI", {
  onVideosLoaded: (callback) =>
    ipcRenderer.on("videos-loaded", (event, videos) => callback(videos)),
  loadLastVideos: () => ipcRenderer.invoke("load-last-videos"),
  saveLastVideos: (videos) => ipcRenderer.send("save-last-videos", videos),
});
